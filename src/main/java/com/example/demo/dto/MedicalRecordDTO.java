...
public class MedicalRecordDTO {
    ...
    public MedicalRecordDTO(Integer recordId, LocalDate visitDate, String symptoms, String diagnosis,
                             String treatmentDetail, String treatmentResult, String note,
    ...
    public String getTreatmentDetail() { return treatmentDetail; }
    public void setTreatmentDetail(String treatmentDetail) { this.treatmentDetail = treatmentDetail; }
