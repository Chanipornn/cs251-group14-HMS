...
public class DoctorStaffLoginApiController {
        ...
        try {
            ...
            if (userOptional.isPresent()) {
                ...
                if (user.getPassword().equals(password)) {
                    ...
                    // แปลง Enum เป็น String (เช่น "DOCTOR" หรือ "STAFF") เพื่อให้เช็คง่ายและเซฟลง Session ได้
                    ...
                    if ("DOCTOR".equalsIgnoreCase(roleName)) {
                        ...
                        if (staffOptional.isPresent()) {
                            ...
                            return ResponseEntity.status(HttpStatus.OK).body(Map.of(
                                    "status", true, 
                                    "message", "เข้าสู่ระบบสำเร็จ (เจ้าหน้าที่)",
                                    "UserID", userId, 
                                    "name", staff.getName(), 
                                    "role", "Staff"
                            ));
    ...
    public ResponseEntity<?> getCurrentUser(HttpSession session) {
        // ดึงข้อมูลจาก Session ที่เราเซฟไว้ตอน Login
